...
class DesignableView: UIView {
  ...
  func allColorClear() {
    ...
    func setup() {
        ...
        let d = DesignableView_(frame: bounds)
        ...
        if grDebug {
            ...
            let d = DesignableViewDebug(frame: bounds)
            d.backgroundColor = .clear
            d.tag = 44
            d.grStartPoint = grStartPoint
            d.grEndPoint = grEndPoint
...
//  }
  ...
  func createCopy() -> DesignableView {
    DesignableView()
  }
...
extension DesignableView: NSCopying {
  func copy(with zone: NSZone? = nil) -> Any
  {
    let d = DesignableView()
    d.frame = self.frame
    d.backgroundColor = .clear
    d.figureType = figureType
    d.starRadius = starRadius
...
@IBDesignable
class DesignableViewDebug: UIView {
